    ...
    <div className="flex h-full w-full overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden pb-16 md:pb-0">
        <TopBar
          ...
          crossBusiness={currentView === 'week' || currentView === 'media'}
          hideSearch={currentView === 'week' || currentView === 'media' || currentView === 'cycles'}
        />
      ...
      >
        {NAV_LINKS.filter(({ id }) => ['today', 'media', 'dashboard', 'review'].includes(id)).map(({ id, label, Icon }) => (
          <button
            key={id}
