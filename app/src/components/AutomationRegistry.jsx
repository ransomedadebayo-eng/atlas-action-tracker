...
import { useAutomationRegistry, useRunAutomation } from '../hooks/useAtlasOs.js'
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-text-secondary">What writes to Today, Review, Decide, Journal, or reports only.</p>
        </div>
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-bg-surface">
        <div className="grid grid-cols-[1.2fr_1fr_1fr_1.4fr_auto] gap-3 border-b border-border px-4 py-3 text-[10px] font-bold uppercase tracking-widest text-text-muted">
        ...
        {jobs.map(job => (
          <div key={job.id} className="grid grid-cols-1 gap-3 border-b border-border px-4 py-4 last:border-b-0 md:grid-cols-[1.2fr_1fr_1fr_1.4fr_auto] md:items-center">
            <div>
            ...
            <button
              ...
              onClick={() => runAutomation.mutate(job.id)}
