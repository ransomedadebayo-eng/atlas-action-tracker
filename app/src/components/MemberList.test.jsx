...
describe('MemberList principals', () => {
  ...
  it('includes agent principals on the default All tab', () => {
    render(<MemberList />)
    expect(screen.getByRole('heading', { name: 'Active Principals' })).toBeTruthy()
  ...
  it('shows only agents when the Agents tab is selected', () => {
    render(<MemberList />)
