...
describe('DiscussionThread',()=>{
  ...
  it('extracts canonical mentions without duplicates',()=>{expect(mentionsFrom('Ask @Nicole and @nicole-codex then @ransomed and @Nicole')).toEqual(['nicole','nicole-codex','ransomed'])});
