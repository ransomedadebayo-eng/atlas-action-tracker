...
export const mediaApi = {
  current: () => request('/media/current'),
  get: (weekStart) => request(`/media/${encodeURIComponent(weekStart)}`),
  upsert: (data) => request('/media/plans/upsert', { method: 'POST', body: data }),
  updateStatus: (id, data) => request(`/media/items/${encodeURIComponent(id)}/status`, { method: 'POST', body: data }),
  recordFeedback: (id, data) => request(`/media/items/${encodeURIComponent(id)}/feedback`, { method: 'POST', body: data }),
  startTwitter: (date, data) => request(`/media/daily/${encodeURIComponent(date)}/twitter/start`, { method: 'POST', body: data }),
  recordSyncManifest: (data) => request('/media/sync-manifests', { method: 'POST', body: data }),
};
