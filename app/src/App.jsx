...
const MediaDietPage = React.lazy(() => import('./components/MediaDietPage.jsx'))
...
export default function App() {
  ...
  function renderView() {
    switch (currentView) {
      ...
      case 'week':
        return <WeekPage weekStart={weekStart} onNavigateWeek={navigateWeek} onSelectAction={openAction} onOpenMedia={() => navigateView('media')} />
      case 'media':
        return <MediaDietPage onOpenToday={() => navigateView('today')} />
      case 'projects':
