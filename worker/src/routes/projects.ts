...
router.post('/', async (c) => {
  try {
    ...
    const defaultLead = defaultOwnerForActor(actor);
    ...
    const project: Row = {
      ...
      lead_id: body.lead_id || defaultLead,
      members: serializeJsonArray(body.members === undefined ? [defaultLead] : body.members),
