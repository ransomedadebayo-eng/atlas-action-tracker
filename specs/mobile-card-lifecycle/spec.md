...
1. Active task cards and rows in Today, All Tasks, and Kanban show visible `Complete` and `Archive` actions at mobile and desktop widths, with at least 44px targets.
...
- Today, All Tasks, and Kanban visibly expose both controls on mobile and desktop web.
