...
select throws_ok($$select public.upsert_atlas_notification_preference('ransomed','email','all','immediate',null,'codex',0)$$,'42501','ATLAS_NOTIFICATION_PRINCIPAL_REQUIRED','a principal cannot change another principal''s notification preferences');
